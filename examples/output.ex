...
def main() do
  IO.puts("Initiating Swarm...")
  # Swarm Initiation: DynamicSupervisor (OTP)
  DynamicSupervisor.start_child(Swibe.AgentSupervisor, {SwibeAgent.Worker, %{name: "Alpha"}})
  DynamicSupervisor.start_child(Swibe.AgentSupervisor, {SwibeAgent.Worker, %{name: "Beta"}})
  IO.puts("[ELIXIR] Swarm supervise tree active with 2 agents.")
  IO.puts("Swarm active.")
end
# Start Ritual
